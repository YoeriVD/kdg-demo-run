...
namespace KdgApplication.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TextController : KdgApplication.Controllers.TextController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, KdgApplication.Models.AddTextModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(KdgApplication.Models.AddTextModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
