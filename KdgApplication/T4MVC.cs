...
{
    public static KdgApplication.Controllers.HomeController Home = new KdgApplication.Controllers.T4MVC_HomeController();
    public static KdgApplication.Controllers.TextController Text = new KdgApplication.Controllers.T4MVC_TextController();
